...
const DeleteInventoryItemModal: React.FC<DeleteInventoryItemModalProps> = ({ isOpen, onClose, onConfirm, itemName }) => {
                ...
                <div className="text-center">
                    ...
                    <div className="mt-2 px-7 py-3">
                        <p className="text-sm text-brand-text-secondary">
                            Are you sure you want to delete <span className="font-bold">{itemName}</span>? This will permanently delete the item and all of its stock adjustment history. This action cannot be undone.
                        </p>
                    </div>
